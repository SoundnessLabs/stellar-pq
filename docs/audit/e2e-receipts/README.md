...
| [`2026-06-11-verifier-mainnet.json`](2026-06-11-verifier-mainnet.json) | 2026-06-11 | **mainnet** | Verifier `CA5RY3BUC4AXNQ4MJJITOUZVMFO3MW3CF4743SIAD46CGY4ICSU6J7OY` | WASM byte-identical to the testnet artifact (`eb27c1d6…`). On-chain `verify → true` [submitted as a real transaction](https://stellar.expert/explorer/public/tx/39559d91354d478fb9b522533b4e4213fdeba0026dbc5e7d1ffe46c9599a2e77); wrong-message → `false` confirmed via read-only simulation. |
